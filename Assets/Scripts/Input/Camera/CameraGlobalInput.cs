...
namespace CMF {
    ...
    public class CameraGlobalInput : CameraInput {
        [SerializeField] private InputActionReference cameraInputAxis;
        ...
        private void OnEnable() {
            cameraInputAxis.action.Enable();
        }

        public override float GetHorizontalCameraInput() {
            //Get raw mouse input;
            float _input = cameraInputAxis.action.ReadValue<Vector2>().x;
        ...
        public override float GetVerticalCameraInput() {
            //Get raw mouse input;
            float _input = cameraInputAxis.action.ReadValue<Vector2>().y;
